...
def preprocess_and_save():
    ...
    # Identify unparseable and fill with medians (as in your EDA)
    ...
    # Date parsing (same approach, kept minimal)
    ...
    # Drop rows where Description is NaN (as in your steps)
    if 'Description' in recipes.columns:
        recipes = recipes.dropna(subset=['Description'])

    # Parse and clean string columns (your exact fields)
    ...
    # Combined text (same as your code)
    ...
    # Derived columns (same as your code)
    ...
    # Final subset (exactly as you chose)
    important_columns = [
        'Name',
        'Image_first',
